...
//! - For fields with casts: use `spec_cast: as Type`
//! - For fields without casts: use `spec_cast:  ,` (empty)
//!
...
macro_rules! struct_marshaller_2 {
    ...
    (
        ...
        field1: {
            ...
            spec_cast: $cast1:tt $cast_type1:ty,
        },
        field2: {
            ...
            spec_cast: $cast2:tt $cast_type2:ty,
        }
    ) => {
        verus! {
        ...
        impl $format_name {
            pub open spec fn spec_new() -> Self {
                $format_name {
                    field1_fmt: <$fmt_type1>::spec_new(),
                    field2_fmt: <$fmt_type2>::spec_new(),
                }
            }
        ...
        impl Marshal for $format_name {
            ...
            open spec fn parse(&self, data: Seq<u8>) -> Self::DV {
                ...
                let field1_value = self.field1_fmt.parse(data.subrange(0, field1_end));
                let field2_value = self.field2_fmt.parse(data.subrange(field1_end, field2_end));
                
                Self::DV {
                    $spec_field1: field1_value $cast1 $cast_type1,
                    $spec_field2: field2_value $cast2 $cast_type2,
                }
            }
            ...
            open spec fn marshallable(&self, value: Self::DV) -> bool {
                &&& self.field1_fmt.marshallable(value.$spec_field1 as int)
                &&& self.field2_fmt.marshallable(value.$spec_field2 as int)
            }
    ...
    // Variant without casts (both fields have no cast)
    (
        format_name: $format_name:ident,
        impl_type: $impl_type:ty,
        spec_type: $spec_type:ty,
        ...
        struct_marshaller_2! {
            ...
            spec_type: $spec_type,
            field1: {
                impl_field: $impl_field1,
                spec_field: $spec_field1,
                formatter_type: $fmt_type1,
                formatter_spec_new: $fmt_spec_new1,
                formatter_new: $fmt_new1,
                spec_cast:   ,  // Empty - will just use the value directly
            },
            field2: {
                impl_field: $impl_field2,
                spec_field: $spec_field2,
                formatter_type: $fmt_type2,
                formatter_spec_new: $fmt_spec_new2,
                formatter_new: $fmt_new2,
                spec_cast:   ,
            }
            @nocast
        }
    ...
    // Internal variant that handles no-cast case
    (
        format_name: $format_name:ident,
        impl_type: $impl_type:ty,
        spec_type: $spec_type:ty,
        ...
        impl Marshal for $format_name {
            ...
            open spec fn parse(&self, data: Seq<u8>) -> Self::DV {
                ...
                Self::DV {
                    $spec_field1: field1_value,
                    $spec_field2: field2_value,
                }
            }
