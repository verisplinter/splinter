...
impl<C: ResizableUniformSizedElementSeqMarshallingConfig> Premarshalling<Seq<int>, Vec<u64>> /*<Seq<C::EltDV>, Vec<C::Elt>>*/ for ResizableUniformSizedElementSeqMarshalling<C> {
